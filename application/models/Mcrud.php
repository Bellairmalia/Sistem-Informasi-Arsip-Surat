...
class Mcrud extends CI_Model {
	...
	var $tbl_klasifikasi		 = 'tbl_klasifikasi';
	var $tbl_disposisi			 = 'tbl_disposisi';
	...
	public function save_klasifikasi($data)
	{
		$this->db->insert($this->tbl_klasifikasi, $data);
		return $this->db->insert_id();
	}

	public function update_klasifikasi($where, $data)
	{
		$this->db->update($this->tbl_klasifikasi, $data, $where);
		return $this->db->affected_rows();
	}

	public function delete_klasifikasi_by_id($id)
	{
		$this->db->where('id_klasifikasi', $id);
		$this->db->delete($this->tbl_klasifikasi);
	}
	...
	public function save_ds($data)
	{
		$this->db->insert($this->tbl_disposisi, $data);
		return $this->db->insert_id();
	}

	public function update_ds($where, $data)
	{
		$this->db->update($this->tbl_disposisi, $data, $where);
		return $this->db->affected_rows();
	}

	public function delete_ds_by_id($id)
	{
		$this->db->where('id_disposisi', $id);
		$this->db->delete($this->tbl_disposisi);
	}

	public function delete_ds_by_no_surat($no_surat)
	{

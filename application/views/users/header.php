...
<head>
 ...
 <style type="text/css">
  ...
  tr:hover{
	...
	<?php
	if ($sub_menu == "" or $sub_menu == "profile" or $sub_menu == "lap_sk" or $sub_menu == "lap_sm" or $sub_menu == "lap_ds") {?>
	<!-- Theme JS files -->
	...
	<?php
		...
		<?php
	if ($sub_menu == "pengguna" or $sub_menu == "bagian" or $sub_menu == "klasifikasi" or $sub_menu == "sm" or $sub_menu == "sk" or $sub_menu == "ds" or $sub_menu == "data_sm" or $sub_menu == "data_sk" or $sub_menu == "data_ds") {?>
	<!-- Theme JS files -->
...
<body>
	...
	<div class="navbar navbar-default">
		<div class="navbar-header">
			<a class="navbar-brand"><b><font color="white">Aplikasi Manajemen Arsip</b></font></a>

			 <style type="text/css">
        .navbar-default {
          background: linear-gradient(to right, #000000, #f1f1f1);
			...
			<div class="sidebar sidebar-main">
				<div class="sidebar-content">
					...
					<!-- /user menu -->
					 ...
					 <style type="text/css">
        .sidebar-main {
          background: radial-gradient(circle at top left, #fdbb2b, #22c1c3);
          ...
          color: white;
					...
					<div class="sidebar-category sidebar-category-visible">
		                ...
		                if ($user->row()->level == 's_admin') { ?>
										...
										<li class="<?php if ($sub_menu == "klasifikasi") { echo 'active';}?>"><a href="users/klasifikasi"><i class="icon-cube"></i>KLASIFIKASI</a></li>
									</ul>
								</li>
								<?php
								} ?>

								<li class="<?php if ($sub_menu == "sk" or $sub_menu == "sm" or $sub_menu == "date_sunrise(timestamp)				" ) { echo 'active';}?>">
									...
									<ul>
										...
										<li class="<?php if ($sub_menu == "ds") { echo 'active';}?>"><a href="users/ds"><i class="icon-folder2"></i> DISPOSISI</a></li>

									</ul>
								</li>


								<li class="<?php if ($sub_menu == "lap_sk" or $sub_menu == "lap_sm" or $sub_menu == "lap_ds") { echo 'active';}?>">
									...
									<ul>
										...
										<li class="<?php if ($sub_menu == "lap_ds" or $sub_menu == "data_ds") { echo 'active';}?>"><a href="users/lap_ds"><i class="icon-file-empty2"></i> DISPOSISI</a></li>
									</ul>
								</li>

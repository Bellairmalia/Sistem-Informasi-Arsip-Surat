...
<html>
  ...
  <body onload="window.print()">
   ...
   <table border="0" width="100%">
    ...
    <h5 align="center"><font size="2">Laporan Surat Keluar</h5>
    <p>
    <table rules="all" border="1" width="100%">
      ...
      foreach ($sql->result() as $baris) {?>
        <tr>
          <td><?php echo $no; ?></td>
          <td><?php echo date('d-m-Y',strtotime($baris->tgl_sk)); ?></td>
          <td><?php echo $baris->no_surat; ?></td>
          <td><?php echo $baris->kepada; ?></td>
          <td><?php echo $baris->dari; ?></td>
          <td><?php echo $baris->tembusan; ?></td>

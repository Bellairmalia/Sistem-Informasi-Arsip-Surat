					...
					<form action="" method="post">
						<div class="panel panel-body login-form">
							<div class="text-center">
								...
								<h5 class="content-group"><b>APLIKASI MANAJEMEN SURAT<p>PT. Pupuk Sriwijaya</p>
									<div class="icon-object border-slate-300 text-slate-300"><img src="assets/pusri.png" alt="Logo Surat Menyurat" width="50"></div>
								</b><small class="display-block">Silahkan Masuk</small></h5>
								<?php
